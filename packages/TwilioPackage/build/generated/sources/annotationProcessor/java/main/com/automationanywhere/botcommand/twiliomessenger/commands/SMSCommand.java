...
public final class SMSCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SMSCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.sendSMS((SecureString)convertedParameters.get("authSID"),(SecureString)convertedParameters.get("authToken"),(String)convertedParameters.get("senderNumber"),(String)convertedParameters.get("recipientNumber"),(String)convertedParameters.get("messageBody")));
      return logger.traceExit(result);
    }
    catch (ClassCastException e) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.IllegalParameters","sendSMS"));
    }
